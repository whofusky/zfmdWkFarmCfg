...
#       fushikai@20190409@modify 版本号文件重新单独文件@v0.0.0.5
#       
#
#############################################################################
...
#toJudgeFile[0]="/zfmd/wpfs20/scada2/trylog/dtV_${logFNDate}.txt"
##toJudgeFile[0]="/zfmd/wpfs20/scada2/trylog/fusk_${logFNDate}.txt"
#toJudgeFile[1]="/zfmd/wpfs20/scada2/trylog/apdu_${logFNDate}.txt"
#toJudgeFile[2]="/zfmd/wpfs20/scada2/trylog/scada_${logFNDate}.txt"
toJudgeFile[0]="/zfmd/wpfs20/scada2/trylog/dtV.txt"
toJudgeFile[1]="/zfmd/wpfs20/scada2/trylog/apdu.txt"
toJudgeFile[2]="/zfmd/wpfs20/scada2/trylog/scada.txt"
